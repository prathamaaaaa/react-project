...
const Content = () => {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="w-screen h-auto flex flex-col items-center justify-center bg-black overflow-hidden no-scrollbar px-0 relative"
    >
      <motion.div className="grid grid-cols-1 md:grid-cols-12 w-full px-0 bg-red-200 ">
...
<h2 className="text-3xl md:text-2xl lg:text-3xl font-bold">Robotics and Automation</h2>
        ...
        {/* Second div */}
        <div className="md:col-span-6  h-auto flex flex-col justify-center items-start text-white space-y-6 pt-[160px] pl-[136px] pr-[91px] order-3 md:order-4">
        ...
        <div className="md:col-span-6  lg:h-[70vh] md:h-[60vh] bg-[#171717] shadow-2xl relative flex items-center justify-center md:justify-end py-6 md:py-0 px-4 md:px-0 order-2 md:order-4">
          <motion.div
            ref={div2Ref}
            className="w-full md:w-[94%] lg:w-[92%] h-[250px] md:h-[70%] lg:h-[75%] bg-gradient-to-r from-gray-900 via-gray-800 to-black rounded-2xl shadow-lg flex items-center justify-center text-white text-lg lg:text-3xl md:text-xl font-semibold md:absolute md:-right-6 lg:-right-12 "
        ...
        {/* Third div */}
        <div className="md:col-span-6 h-auto  flex flex-col justify-center items-start text-white space-y-6 pt-[160px] pl-[136px] pr-[91px]  order-5 md:order-6">
